...
That `data-tina-field` is what makes the heading clickable in the editor. You will find it throughout this starter's components, on titles, body copy, hero images, and dates.
...
Visual editing is only half the story. The fields an editor sees are generated from your content model, which is the subject of the [next post](/blog/content-modeling/).
