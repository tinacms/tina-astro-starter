...
The "MDX" part of MDX is where the body can call out to real components. This starter ships one as a demo — a YouTube embed defined in [`src/components/mdx/YouTubeEmbed.astro`](https://github.com/tinacms/tina-astro-starter/blob/main/src/components/mdx/YouTubeEmbed.astro) and registered as a template on the blog body field. Editors insert it from the rich-text toolbar; the renderer mounts the real Astro component:
